...
const features = [
  ...
  },
  {
    ...
    description: 'Продавайте в Центральной Азии и по всему миру через одну платформу.',
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Полный набор инструментов для выхода на рынки Центральной Азии и глобальные рынки
          </p>
        </motion.div>
