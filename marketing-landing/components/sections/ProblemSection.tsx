      ...
      <div className="container mx-auto px-6">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Выход на глобальные рынки из Кыргызстана не должен быть сложным
          </h2>
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Традиционные платформы требуют технических знаний и много времени. Мерчанты из Кыргызстана сталкиваются с барьерами при выходе на международные рынки.
          </p>
        </motion.div>
